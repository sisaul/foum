      ...
      <div className="max-w-[88rem] mx-auto">
        <div className="container-padding section-spacing">
          ...
          <div className="space-y-16">
            <section>
              <h2 className="caption mb-4">USAGE DATA</h2>
              <p className="body">
            ...
            <section>
              <h2 className="caption mb-4">LOCATION DATA</h2>
              <p className="body">
                We may use and store information about your location if you give us permission to do so
                (&ldquo;Location Data&rdquo;). We use this data to provide features of our Service, to improve and
            ...
            <section>
              <h2 className="caption mb-4">TRACKING COOKIES DATA</h2>
              <p className="body">
            ...
            <section>
              <h2 className="caption mb-4">SECURITY OF DATA</h2>
              <p className="body">
            ...
            <section>
              <h2 className="caption mb-4">CHANGES TO THIS PRIVACY POLICY</h2>
              <p className="body">
                ...
                the &ldquo;effective date&rdquo; at the top of this Privacy Policy.
              </p>
            </section>
          </div>
        </div>
