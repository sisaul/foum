...
export default function StoriesContentClient({ heroImage, titleSection, introTextSection, contentSections }: StoriesContentClientProps) {
  return (
      ...
      <div className="flex flex-col gap-16 md:gap-32">
        ...
        {introTextSection && (
          <TextSection
            ...
            align={introTextSection.align}
            maxWidth={introTextSection.maxWidth}
          />
        )}
