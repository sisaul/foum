...
- Name: Navigation >> can navigate to /terms-and-conditions
- Location: /Users/siimjooseps/Projects/foum/tests/navigation.spec.ts:14:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/terms-and-conditions
Call log:
  - navigating to "http://localhost:3001/terms-and-conditions", waiting until "load"
