...
- Name: Navigation >> can navigate to /stories
- Location: /Users/siimjooseps/Projects/foum/tests/navigation.spec.ts:14:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/stories
Call log:
  - navigating to "http://localhost:3001/stories", waiting until "load"
